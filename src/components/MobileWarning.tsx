...
const MobileWarning: React.FC<MobileWarningProps> = ({ onReturnToLanding }) => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-bg-primary to-bg-secondary text-text-primary px-4 py-6 overflow-hidden">
      <div className="max-w-md w-full mx-auto bg-bg-secondary/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-border-primary/50">
        <motion.div
        ...
        >
          ...
          <p className="text-text-subtle text-xs italic leading-snug mb-8">
          ...
          <motion.button
            ...
            className="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-full text-black bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 shadow-md"
