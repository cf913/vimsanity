  ...
  const normalModeActions: KeyActionMap = {
    ...
    j: () => {
      ...
      const nextLineLength =
        (nextLineEnd === -1 ? editableText.length : nextLineEnd) -
        nextLineStart;
      ...
      <div className="flex gap-4 text-zinc-400 mt-4 justify-center">
        {mode === "normal" ? (
          <>
            ...
            <kbd
              className={`px-3 py-1 bg-zinc-800 rounded-lg transition-all duration-150 ${lastKeyPressed === "i"
                  ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/50 scale-110"
                  : ""
                }`}
            >
            ...
            <kbd
              className={`px-3 py-1 bg-zinc-800 rounded-lg transition-all duration-150 ${lastKeyPressed === "x"
                  ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/50 scale-110"
                  : ""
                }`}
            >
            ...
            <kbd
              className={`px-3 py-1 bg-zinc-800 rounded-lg transition-all duration-150 ${lastKeyPressed === "d"
                  ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/50 scale-110"
                  : ""
                }`}
            >
          ...
          <kbd
            className={`px-3 py-1 bg-zinc-800 rounded-lg transition-all duration-150 ${lastKeyPressed === "Escape"
                ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/50 scale-110"
                : ""
              }`}
          >
