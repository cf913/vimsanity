    ...
    <div className="max-w-7xl mx-auto p-6">
                ...
                {category.motions.map((motion, idx) => (
                  ...
                  >
                    <div className="col-span-3 flex items-center gap-2">
                      <KBD keys={motion.command} className={colors.command} />
                    ...
                    <div className="col-span-4">
                      ...
                      <code className="text-sm text-zinc-300 bg-zinc-800/50 px-2 py-1 rounded font-mono">
                        {motion.before}
                      </code>
                    </div>
      ...
      <div className="mt-12 p-6 bg-zinc-800/50 rounded-lg border border-zinc-700">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm text-zinc-300">
          <div>
            <strong className="text-emerald-400">Cursor notation:</strong> The <code>|</code> symbol shows cursor position
          </div>
          <div>
            <strong className="text-blue-400">Modes:</strong> Commands work in NORMAL mode unless noted as INSERT
          </div>
          <div>
            <strong className="text-amber-400">Combinations:</strong> Many commands can be combined (e.g., <code>d + w</code> = delete word)
          </div>
          <div>
            <strong className="text-red-400">Practice:</strong> Use the playground (Level 0) to practice any combination!
          </div>
        </div>
      </div>
    </div>
