...
export const keyboardLayout: KeyPosition[] = [
  ...
  { key: '1', label: '1', displayLabel: '1', row: 0, column: 1.5 },
  { key: '2', label: '2', displayLabel: '2', row: 0, column: 2.5 },
  { key: '3', label: '3', displayLabel: '3', row: 0, column: 3.5 },
  { key: '4', label: '4', displayLabel: '4', row: 0, column: 4.5 },
  { key: '5', label: '5', displayLabel: '5', row: 0, column: 5.5 },
  { key: '6', label: '6', displayLabel: '6', row: 0, column: 6.5 },
  { key: '7', label: '7', displayLabel: '7', row: 0, column: 7.5 },
  { key: '8', label: '8', displayLabel: '8', row: 0, column: 8.5 },
  { key: '9', label: '9', displayLabel: '9', row: 0, column: 9.5 },
  { key: '0', label: '0', displayLabel: '0', row: 0, column: 10.5 },
  { key: '-', label: '-', displayLabel: '-', row: 0, column: 11.5 },
  { key: '=', label: '=', displayLabel: '=', row: 0, column: 12.5 },
  ...
  { key: '[', label: '[', displayLabel: '[', row: 1, column: 11.5 },
  { key: ']', label: ']', displayLabel: ']', row: 1, column: 12.5 },
  { key: '\\', label: '\\', displayLabel: '\\', row: 1, column: 13.5, width: 1.5 },
  ...
  { key: ';', label: ';', displayLabel: ';', row: 2, column: 10.75 },
  { key: '\'', label: '\'', displayLabel: '\'', row: 2, column: 11.75 },
  { key: 'Enter', label: 'Enter', displayLabel: '⏎', row: 2, column: 12.75, width: 2.25, isSpecial: true },
  ...
  { key: ',', label: ',', displayLabel: ',', row: 3, column: 9.25 },
  { key: '.', label: '.', displayLabel: '.', row: 3, column: 10.25 },
  { key: '/', label: '/', displayLabel: '/', row: 3, column: 11.25 },
  { key: 'ShiftRight', label: 'Shift', displayLabel: '⇧', row: 3, column: 12.25, width: 2.75, isSpecial: true },

  // Row 5 - Spacebar row
  { key: 'Control', label: 'Ctrl', displayLabel: 'Ctrl', row: 4, column: 0, width: 1.5, isSpecial: true },
  { key: 'Alt', label: 'Alt', displayLabel: 'Alt', row: 4, column: 1.5, width: 1.5, isSpecial: true },
  { key: 'Meta', label: 'Cmd', displayLabel: '⌘', row: 4, column: 3, width: 1.5, isSpecial: true },
  { key: ' ', label: 'Space', displayLabel: '', row: 4, column: 4.5, width: 6 },
  { key: 'MetaRight', label: 'Cmd', displayLabel: '⌘', row: 4, column: 10.5, width: 1.5, isSpecial: true },
  { key: 'AltRight', label: 'Alt', displayLabel: 'Alt', row: 4, column: 12, width: 1.5, isSpecial: true },
  { key: 'ControlRight', label: 'Ctrl', displayLabel: 'Ctrl', row: 4, column: 13.5, width: 1.5, isSpecial: true },
